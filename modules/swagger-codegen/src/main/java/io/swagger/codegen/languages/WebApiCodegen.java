...
public class WebApiCodegen extends DefaultCodegen implements CodegenConfig {
    protected String invokerPackage = "IO.Swagger.Server";
    protected String groupId = "io.swagger";
    protected String artifactId = "swagger-webapi-server";
    protected String artifactVersion = "1.0.0";
    protected String sourceFolder = "src/main/webapi";

    public WebApiCodegen() {
        super();
        outputFolder = "generated-code/webapi";
	...
	//	(sourceFolder + File.separator + invokerPackage).replace(".", java.io.File.separator), "Configuration.cs"));
        ...
        //supportingFiles.add(new SupportingFile("ApiException.mustache", (sourceFolder + File.separator + invokerPackage).replace(".", java.io.File.separator), "ApiException.cs"));
    ...
    public String getHelp() {
        return "Generates a CSharp/WebApi server library.";
    }
